        ...
        <?php echo form_open('database/export', array('method' => 'get')); ?>
			<table class="table" id="site_basic" >
				...
				<tr>
					<th> 数据库备份类型：</th>
					<td>
                        <label><input type="radio" name="export_type" value="all" onclick="$('#customtable').hide();" checked class="form-check-input"> 备份全部表</label>&nbsp;&nbsp;
                        <label><input type="radio" name="export_type" value="custom" onclick="$('#customtable').show();" class="form-check-input"> 自定义备份</label>
					</td>
				</tr>
                ...
                <tr>
                    <th> 备份文件名：</th>
                    <td>
                        <input type="text" class="form-control" name="filename" value="<?php echo date('YmdHis');?>">.sql
                    </td>
                </tr>
                <tr>
                    <th> 压缩备份文件：</th>
                ...
                <tr>
                    <th> 分卷大小：</th>
                    <td>
                        <input type="text"class="form-control" name="volume_size" value="2048"> KB
                    </td>
                </tr>
				<tr>
					<th></th>
