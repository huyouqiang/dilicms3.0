...
<div class="headbar">
	...
	<div class="operating" style="position:relative; overflow:visible ">
        ...
        $s =  urlencode($s);
        ?>
        <a href="<?php echo backend_url('excel/exportExcel','model='.$s);?>;"><button class="operating_btn" type="button"><span class="export">导出EXCEL</span></button></a>
...
<div class="pages_bar pagination"><?php echo $provider['pagination']; ?> <span>共<b style="color:red;"><?php echo $provider['total_rows']; ?></b>条记录</span></div>
